        ...
        >
            ...
            <div className="grow w-8/12 mb-4 mx-auto">
                <div className='flex justify-center flex-wrap gap-8 '>
                    <figure className='relative group h-[400px] w-[400px] overflow-hidden rounded-lg'
                        style={{
                            boxShadow: '18px 18px  rgba(0, 0, 0, 0.6)'
                        }}
                    >
                        <img
                            src={"/facility_1.jpg"}
                    ...
                    <figure className='relative group h-[400px] w-[400px] overflow-hidden rounded-lg' style={{
                        boxShadow: '18px 18px  rgba(0, 0, 0, 0.6)'
                    }}>
                        <img
                            src={"/facility_2.jpg"}
                    ...
                    <figure className='relative group h-[400px] w-[400px] overflow-hidden rounded-lg' style={{
                        boxShadow: '18px 18px  rgba(255, 255, 255, 0.6)'
                    }}>
                        <img
                            src={"/facility_3.jpg"}
                            alt="roller"
                    ...
                    <figure className='relative group h-[400px] w-[400px] overflow-hidden rounded-lg' style={{
                        boxShadow: '18px 18px  rgba(97, 98, 56, 0.6)'
                    }}>
                        <img
                            src={"/facility_5.jpg"}
                            alt="yoga"
                    ...
                    <figure className='relative group h-[400px] w-[400px] overflow-hidden rounded-lg' style={{
                        boxShadow: '18px 18px  rgba(255, 255, 255, 0.4)'
                    }}>
                        <img
                            src={"/facility_6.jpg"}
                            alt="abs"
